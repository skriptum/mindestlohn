...
- especially men and eastern german high discordanca
...
why eastern germany also factor?

- post wende turmoil additional pressure (Treuhand)
- cultural
- Steffen Mau sociological survey
- labor market different from West (policy failure)
...
MW --> D(lack of mobility) & E(Status Discordance) & F(Disappointment)
--> AfD((Populist voting))
O -.-> AfD
```
