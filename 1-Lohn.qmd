...
-   Germany's first AfD district administrator (Landrat)
    -   Robert Sesselmann
    -   prevails in run-off election against conservative CDU
    -   52.8% to 47.2%
...
=\> 1% increase in MW recipoients =\> 0.7% increase in AfD
    share
...
Populism = multicausal, not only socioeconomic, but also sociodemographic, cultural, ...
...
lack of social mobility [@dodinSocialMobilityGermany2021]
...
- before, exit (abstention) only option for voters incontempt with situation
